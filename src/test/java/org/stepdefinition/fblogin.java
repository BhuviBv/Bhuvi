...
public class fblogin extends Baseclass{
	...
	@Given("To launch the chrome and maximise window")
	public void to_launch_the_chrome_and_maximise_window() {
		LaunchBrowser();
		windowMaximize();
	...
	public void to_pass_valid_username_in_email_field() {
		...
		passText("bhuvanesh2920@gmail.com", f.getEmailId());
	...
	public void to_check_whether_navigate_to_the_home_page_or_not() {
	   System.out.println("To check your credentails");
	}

	@Then("To close the broswer")
	public void to_close_the_broswer() {
		closeEntireBrowser();
